...
"""
    ...
    async def back_to_manu():
        input(f"{palette.error}\n!! Press Enter to return to the main menu !!{palette.fuck}\n")
...
"""
        ...
        if ch == "01":
            ...
            print(palette.error+" Starting in 3 Seconds!"+palette.fuck)
            time.sleep(3)
